...
class MovimentationResource extends BaseResource
{
    /**
        ...
        return [
            ...
            'files'                      => $this->whenLoaded('files', function () {
                return $this->files->map(function ($file) {
                    return [
                        'id'         => $this->hashIdForModel($file->id, 'movimentationfile'),
                        'src'        => $file->src,
                        'name'       => $file->name,
                        'size'       => $file->size,
                        'type'       => $file->type,
            ...
            'recurring_transaction_id'   => $this->hashIdForModel($this->recurring_transaction_id, 'recurringmovimentation'),
