...
return [
    ...
    'Transaction has been added to the marea.'                                                                                => 'Movimentation a été ajoutée à la marea.',
    'Failed to add transaction: :message'                                                                                     => 'Échec de l\'ajout de la movimentation: :message',
    'Transaction has been removed from the marea.'                                                                            => 'Movimentation a été retirée de la marea.',
    'Failed to remove transaction: :message'                                                                                  => 'Échec du retrait de la movimentation: :message',
    ...
    // Transaction
    "Transaction ':number' has been created successfully."                                                                    => "Movimentation ':number' a été créée avec succès.",
    'Failed to create transaction: :message'                                                                                  => 'Échec de la création de la movimentation: :message',
    "Transaction ':number' has been updated successfully."                                                                    => "Movimentation ':number' a été mise à jour avec succès.",
    'Failed to update transaction: :message'                                                                                  => 'Échec de la mise à jour de la movimentation: :message',
    "Transaction ':number' has been deleted successfully."                                                                    => "Movimentation ':number' a été supprimée avec succès.",
    'Failed to delete transaction: :message'                                                                                  => 'Échec de la suppression de la movimentation: :message',

    // Marea - Additional
    "Marea ':number' has been deleted successfully. :count transaction(s) associated with this marea have also been deleted." => "Marea ':number' a été supprimée avec succès. :count movimentation(s) associée(s) à cette marea ont également été supprimées.",
    ...
    'Transaction has been removed from the maintenance.'                                                                      => 'Movimentation a été retirée de la maintenance.',
    'Failed to remove transaction from maintenance: :message'                                                                 => 'Échec du retrait de la movimentation de la maintenance: :message',
    ...
    "Cannot delete vessel ':name' because it has transactions. Please remove all transactions first."                         => "Impossible de supprimer le navire ':name' car il a des movimentations. Veuillez supprimer toutes les movimentations d\'abord.",
    ...
    "Cannot delete supplier ':name' because they have transactions. Please remove all transactions first."                    => "Impossible de supprimer le fournisseur ':name' car il a des movimentations. Veuillez supprimer toutes les movimentations d\'abord.",
