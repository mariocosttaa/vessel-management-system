...
return [
    ...
    'Transaction has been added to the marea.' => 'Transaction has been added to the marea.',
    'Failed to add transaction: :message' => 'Failed to add transaction: :message',
    'Transaction has been removed from the marea.' => 'Transaction has been removed from the marea.',
    'Failed to remove transaction: :message' => 'Failed to remove transaction: :message',
    ...
    // Transaction
    "Transaction ':number' has been created successfully." => "Transaction ':number' has been created successfully.",
    'Failed to create transaction: :message' => 'Failed to create transaction: :message',
    "Transaction ':number' has been updated successfully." => "Transaction ':number' has been updated successfully.",
    'Failed to update transaction: :message' => 'Failed to update transaction: :message',
    "Transaction ':number' has been deleted successfully." => "Transaction ':number' has been deleted successfully.",
    'Failed to delete transaction: :message' => 'Failed to delete transaction: :message',

    // Marea - Additional
    "Marea ':number' has been deleted successfully. :count transaction(s) associated with this marea have also been deleted." => "Marea ':number' has been deleted successfully. :count transaction(s) associated with this marea have also been deleted.",
    ...
    'Transaction has been removed from the maintenance.' => 'Transaction has been removed from the maintenance.',
    'Failed to remove transaction from maintenance: :message' => 'Failed to remove transaction from maintenance: :message',
    ...
    "Cannot delete vessel ':name' because it has transactions. Please remove all transactions first." => "Cannot delete vessel ':name' because it has transactions. Please remove all transactions first.",
    ...
    "Cannot delete supplier ':name' because they have transactions. Please remove all transactions first." => "Cannot delete supplier ':name' because they have transactions. Please remove all transactions first.",
