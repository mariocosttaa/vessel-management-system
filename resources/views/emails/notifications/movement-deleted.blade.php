...
@section('content')
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        ...
        <tr>
            <td align="center" style="padding-bottom: 32px;">
                <p style="margin: 0; padding: 0; font-size: 16px; color: #374151; line-height: 1.6; text-align: center; max-width: 500px;">
                    {{ trans('emails.A movement has been deleted from the system. Details of the deleted movement are below:', [], $locale ?? 'en') }}
                </p>
            </td>
        </tr>
    </table>
                                    ...
                                    <td style="padding-bottom: 16px; border-bottom: 1px solid #e5e7eb;">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="padding-bottom: 6px;">
                                                    <p style="margin: 0; padding: 0; font-size: 12px; font-weight: 600; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px;">
                                                        {{ trans('emails.Deleted by', [], $locale ?? 'en') }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td>
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="padding-bottom: 6px;">
                                                    <p style="margin: 0; padding: 0; font-size: 12px; font-weight: 600; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px;">
                                                        {{ trans('emails.Deletion Date', [], $locale ?? 'en') }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
        ...
        <tr>
            <td align="center" style="padding-top: 8px;">
                <p style="margin: 0; padding: 0; font-size: 14px; color: #6b7280; line-height: 1.5; text-align: center; max-width: 500px;">
                    <strong style="color: #374151;">{{ trans('emails.Note', [], $locale ?? 'en') }}:</strong> {{ trans('emails.This movement has been permanently deleted from the system and cannot be recovered.', [], $locale ?? 'en') }}
                </p>
            </td>
        </tr>
    </table>
