...
<head>
    ...
    <title>500 - Server Error | {{ config('app.name', 'Bindamy Mareas') }}</title>
    ...
    <style>
        * {
        ...
        .error-code {
            ...
            font-weight: 700;
            line-height: 1;
            background: linear-gradient(to right, hsl(0 84.2% 60.2%), hsl(0 84% 65%));
        ...
        html.dark .error-code {
            background: linear-gradient(to right, hsl(0 84% 65%), hsl(0 84% 70%));
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        }
...
<body>
    <div class="error-container">
        ...
        <h1 class="error-title">{{ __('errors.Server Error') }}</h1>
        <p class="error-description">
            {{ __('errors.We\'re sorry, but something went wrong on our end. Please try again later.') }}
        </p>

        <div class="error-actions">
            <a href="{{ url('/') }}" class="btn btn-primary">{{ __('errors.Go Home') }}</a>
            <a href="javascript:history.back()" class="btn btn-secondary">{{ __('errors.Go Back') }}</a>
        </div>
    </div>
