...
<head>
    ...
    <title>404 - Page Not Found | {{ config('app.name', 'Bindamy Mareas') }}</title>
    ...
    <style>
        * {
        ...
        html.dark .error-code {
            background: linear-gradient(to right, hsl(217 91% 70%), hsl(217 91% 80%));
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        }
...
<body>
    <div class="error-container">
        ...
        <h1 class="error-title">{{ __('errors.Page Not Found') }}</h1>
        <p class="error-description">
            {{ __('errors.The page you\'re looking for doesn\'t exist or has been moved.') }}
        </p>
