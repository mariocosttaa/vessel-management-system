    ...
    <VesselLayout v-if="hasPermission('reports.access')" :breadcrumbs="[
        ...
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            ...
            <div class="rounded-xl border border-sidebar-border/70 dark:border-sidebar-border bg-card dark:bg-card p-6">
                <div>
                    <h1 class="text-2xl font-semibold text-card-foreground dark:text-card-foreground">{{ t('Financial Reports') }}</h1>
                    <p class="text-muted-foreground dark:text-muted-foreground mt-1">{{ t('Select a month and year to view detailed financial reports') }}</p>
                </div>
            </div>
            ...
            <div v-else class="rounded-xl border border-sidebar-border/70 dark:border-sidebar-border bg-card dark:bg-card p-12 text-center">
                <p class="text-muted-foreground dark:text-muted-foreground">{{ t('No financial reports available') }}</p>
            </div>
        </div>
    </VesselLayout>
