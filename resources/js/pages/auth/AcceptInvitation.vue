...
<template>
    ...
    >
        ...
        <div class="space-y-6">
            ...
            <div
                v-if="errorMessage"
                class="rounded-lg border border-destructive/20 bg-destructive/10 px-4 py-3 text-center text-sm font-medium text-destructive dark:bg-destructive/20 dark:text-destructive"
            >
                {{ errorMessage }}
            </div>
            ...
            <Form @submit.prevent="submit" v-slot="{ processing }">
                <div class="space-y-4">
                    <!-- Name Fields - Grouped horizontally -->
                    ...
                    <!-- Password Fields - Grouped horizontally -->
                    <div class="grid grid-cols-2 gap-4">
                        <div class="grid gap-2">
