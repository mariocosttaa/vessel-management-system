...
const startDownload = () => {
    ...
    downloadTimeout = setTimeout(() => {
        ...
        const url = `/panel/${vesselId}/movimentations/history/download-pdf${queryString ? '?' + queryString : ''}`;
...
const startDownloadMonth = () => {
    ...
    downloadTimeout = setTimeout(() => {
        ...
        const queryString = params.toString();
        const url = `/panel/${vesselId}/movimentations/history/${currentDownloadYear.value}/${currentDownloadMonth.value}/download-pdf${queryString ? '?' + queryString : ''}`;
